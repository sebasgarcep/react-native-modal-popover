...
var _a = react_native_1.Dimensions.get('window'), SCREEN_HEIGHT = _a.height, SCREEN_WIDTH = _a.width;
var ARROW_DEG = {
    bottom: '-180deg',
    left: '-90deg',
    right: '90deg',
...
var Popover = (function (_super) {
    ...
    function Popover(props) {
        ...
        _this.measureContent = function (_a) {
            ...
            if (width && height) {
                ...
                var geom = PopoverGeometry_1.computeGeometry(contentSize, _this.props.placement, _this.props.fromRect, _this.props.displayArea, _this.props.arrowSize);
        ...
        _this.startAnimation = function (show) {
            ...
            react_native_1.Animated.timing(_this.state.animation, {
                toValue: show ? 1 : 0,
                duration: 300,
                easing: show ? react_native_1.Easing.out(react_native_1.Easing.back(1.70158)) : react_native_1.Easing.inOut(react_native_1.Easing.quad),
            ...
            return {
                ...
                arrow: [
                    ...
                    _this.props.arrowStyle,
                    {
                        ...
                        transform: [
                            {
                                rotate: ARROW_DEG[_this.state.placement],
                            },
                            {
    ...
    Popover.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if (willBeVisible !== visible) {
            ...
            var geom = PopoverGeometry_1.computeGeometry(contentSize, nextProps.placement, nextProps.fromRect, nextProps.displayArea, nextProps.arrowSize);
            var isAwaitingShow_2 = this.state.isAwaitingShow;
            this.setState(__assign({}, geom, { contentSize: contentSize }), function () {
                if (isAwaitingShow_2) {
                    _this.startAnimation(true);
                }
            });
    ...
    Popover.prototype.render = function () {
        ...
        return (<react_native_1.Modal transparent visible={this.state.visible} onRequestClose={this.props.onClose}>
